      ...
      <article className="mx-auto max-w-4xl px-6 py-10 md:px-8">
        ...
        <div className="mt-8 space-y-5 leading-relaxed text-[#333]" style={{ fontSize: 15 }}>
          <p>
            ...
            문제가 아니라, 학습 지원이 학생의 질문 발생 이후에야 시작된다는 구조적 한계와 맞닿아 있습니다.
          ...
          <p>
            ...
            있습니다. 따라서 시스템은 단순한 질의응답 도구를 넘어, 학습자가 수업 내용을 능동적으로 점검하도록
            유도하는 역할을 수행합니다.
          </p>
          <p>
            2025년 1학기에, 저희는 이러한 시스템을 실제 1,500명 이상의 학생이 수강한 대규모 Python 입문 수업에 한
            학기 동안 적용 및 운영하였습니다. 해당 수업은 기존에 이메일을 통한 문의에만 학습 지원을 의존해야 했기
            때문에, 학생들이 즉시 도움을 받기 어려운 상황이 많았습니다. 이런 상황에서 Predictive Query
            Management는 실시간 지원의 접근성을 높이고, 도움 요청의 심리적 장벽을 낮추는 실행 전략으로
            도입되었습니다.
          </p>
          <p>
            실제 사용 결과, 학생이 먼저 말을 걸지 않아도 학습 대화를 시작할 수 있게 해주는 인터페이스로의 안내
            장치로 기능한 사전 질문은 전체 세션의 상담 부분에서 활용되며, 학생들이 학습 지원에 진입하는 주요
