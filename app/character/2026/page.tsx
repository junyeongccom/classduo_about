...
export default function Character2026Page() {
  return (
    <PageShell
      ...
      lead="클래스듀오의 캐릭터는 장식이 아니라 인터페이스의 일부입니다. 처음 들어온 학생을 안내하고, 답을 기다리는 시간을 채우고, 틀렸을 때 화면을 덜 차갑게 만듭니다. 2026년 라인업은 두 명의 학생 캐릭터와, 학습 개념마다 하나씩 대응되는 스티커 아트 세트로 구성됩니다."
      ...
      <Section title="캐릭터가 하는 일" index={1} accent={ACCENT}>
        ...
        <CardGrid
          items={[
            ...
            {
              title: '대화의 기다림',
              body: '대화형 학습에서 답변을 기다리는 동안 캐릭터가 반응합니다. 빈 로딩 표시 대신 사람이 반응하는 화면을 두면, 같은 대기 시간도 훨씬 짧게 느껴집니다.',
            },
            {
              title: '학습 프로필',
